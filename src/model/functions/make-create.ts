...
export function makeCreate(mixins: Array<Mixin<any, any>>, middlewares: Array<Middleware | Middlewares>): <T>(actionMapOrActionMaps: ActionMaps<T> | ActionMap<T>, initial: T | null) => Node<T> {
    return <T>(actionMapOrActionMaps: ActionMaps<T> | ActionMap<T>, initial: T | null) => {
