...
import { createModelUpdateIfNeeded } from '../template-to-element/create-model-update-if-needed';
import { createAnchorElement } from './functions/create-anchor-element';

export function listModifier(next: TemplateToElement) {
  return (scope: ViewScope, elementTemplate: ElementTemplate) => {
    ...
    if (listProperty && typeof listProperty.value === 'string') {
      ...
      return { element: anchor, contentUpdate};
    }
